...
class Leg:
    ...
    def twist_mechanism(self) -> None:
        ...
        self.twist.twist_joint(segments=self.segments[:-2], twist_amount=twist_amount)
    ...
    def stretch_mechanism(self) -> None:
        ...
        self.stretch.stretch_node(segments=self.segments[:-2], main_control=self.ik_controls[0])
