...
def wing_segments() -> list[Segment]:
    ...
    return [wing_humerus_joint, wing_ulna_joint, wing_manus_joint, wing_phalanx_joint, wing_phalanx_01_joint,
            wing_phalanx_02_joint, wing_manus_01_joint, wing_manus_02_joint, wing_ulna_01_joint,
            wing_ulna_02_joint]
